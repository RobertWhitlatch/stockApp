...
public class Crypto {
    ...
    public String[] getDisplaySet(){
        ...
        displaySet[i++] = "Open: " + open;
        displaySet[i++] = "Close: " + close;
        displaySet[i++] = "High: " + high;
        displaySet[i++] = "Low: " + low;
        displaySet[i++] = "Latest Price; " + latestPrice;
        displaySet[i++] = "Latest Volume: " + latestVolume;
        displaySet[i++] = "Previous Close: " + previousClose;
        displaySet[i++] = "Change: " + change;
        displaySet[i++] = "Change Percentage: " + changePercent;
